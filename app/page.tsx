        ...
        <div className="grid min-h-[calc(100vh-140px)] items-center gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          <div className="relative hidden h-[700px] lg:block">
            <div className="absolute inset-0">
              ...
              {/* Chat Card 2 */}
              <div className="absolute left-1/2 top-20 z-40 w-72 -translate-x-1/2 animate-float-fast">
              ...
              {/* Chat Card 3 */}
              <div className="absolute bottom-12 right-4 z-30 w-80 animate-float-medium">
